...
const notificationFormSchema = z.object({
  ...
  animalUpdates: z.boolean(),
  medicalAlerts: z.boolean(),
  adoptionRequests: z.boolean(),
          ...
          <CardContent className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Animal Updates</FormLabel>
                    <FormDescription>
                      Get updates about animals in your care.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Medical Alerts</FormLabel>
                    <FormDescription>
                      Receive alerts for medical appointments and treatments.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Adoption Requests</FormLabel>
                    <FormDescription>
                      Get notified about new adoption requests.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
